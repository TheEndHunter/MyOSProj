...
namespace Common::Graphics
{
	...
	public:
		...
		const Pixel4Bpp(UINT32 b1, UINT32 b2, UINT32 b3, UINT32 b4);
	...
	public:
		...
		const Pixel3Bpp(UINT32 b1, UINT32 b2, UINT32 b3, UINT32 b4);
	...
	public:
		...
		const Pixel2Bpp(UINT16 b1, UINT16 b2, UINT16 b3, UINT16 b4);
	...
	public:
		...
		const Pixel1Bpp(UINT8 b1, UINT8 b2, UINT8 b3, UINT8 b4);
