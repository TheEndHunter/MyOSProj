...
namespace Common::System::Environment
{
	...
	constinit const CHAR* _CSTR_BAD_BUFFER_SIZE = "BadBufferSize";
	constinit const CHAR* _CSTR_BOOLEAN_FALSE = "False";
	constinit const CHAR* _CSTR_BOOLEAN_TRUE = "True";
	constinit const CHAR* _CSTR_BUFFER_TOO_SMALL = "BufferTooSmall";
	...
	constinit const CHAR* _CSTR_INVALID_PARAMETER = "InvalidParameter";
	constinit const CHAR* _CSTR_IP_ADDRESS_CONFLICT = "IP_ADDRESS_CONFLICT";
	constinit const CHAR* _CSTR_LOAD_ERROR = "LoadError";
	...
	constinit const CHAR* _CSTR_NOT_READY = "NotReady";
	constinit const CHAR* _CSTR_NOT_STARTED = "NOT_STARTED";
	constinit const CHAR* _CSTR_OutOfResources = "OutOfResources";
	...
	constinit const CHAR* _CSTR_ALLOC_STATUS_INVALID_PARAMETER = "InvalidParameter";
...
void UTF<CHAR>::Free(CHAR* str)
{
	...
	CHAR* UTF<CHAR>::ToString(const Efi::Guid guid)
	{
	...
	const CHAR* UTF<CHAR>::ToString(const Efi::Status status)
	{
		switch (status)
		{
