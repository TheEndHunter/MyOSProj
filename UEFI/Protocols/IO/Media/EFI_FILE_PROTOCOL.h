...
namespace EFI
{
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_GET_INFO) (IN EFI_FILE_PROTOCOL* self,IN EFI_GUID* informationType,IN OUT UINTN* bufferSize,OUT VOID* buffer);
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_SET_INFO) (IN EFI_FILE_PROTOCOL* self,IN EFI_GUID* informationType,IN UINTN bufferSize,IN VOID* buffer);
