...
namespace EFI
{
	...
	CONST UINT32 EFI_FILE_PROTOCOL_REVISION = 0x00010000;
	CONST UINT32 EFI_FILE_PROTOCOL_REVISION2 = 0x00020000;
	CONST UINT32 EFI_FILE_PROTOCOL_LATEST_REVISION = EFI_FILE_PROTOCOL_REVISION2;

	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_OPEN) (IN EFI_FILE_PROTOCOL* self,OUT EFI_FILE_PROTOCOL** newHandle,IN CONST CHAR16* fileName,IN EFI_FILE_MODES openMode,IN UINT64 attributes);
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_OPEN_EX) (IN EFI_FILE_PROTOCOL* self, OUT EFI_FILE_PROTOCOL** newHandle, IN CONST CHAR16* fileName, IN EFI_FILE_MODES openMode, IN UINT64 attributes, IN OUT EFI_FILE_IO_TOKEN* token);
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_SET_POSITION) (IN EFI_FILE_PROTOCOL* self,IN UINT64 position);
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_GET_POSITION) (IN EFI_FILE_PROTOCOL* self,OUT UINT64* position);
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_FLUSH) (IN EFI_FILE_PROTOCOL* self);
