...
namespace EFI
{
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_OPEN) (IN EFI_FILE_PROTOCOL* self,OUT EFI_FILE_PROTOCOL** newHandle,IN CHAR16* fileName,IN EFI_FILE_MODES openMode,IN EFI_FILE_ATTRIBUTES attributes);
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_OPEN_EX) (IN EFI_FILE_PROTOCOL* self, OUT EFI_FILE_PROTOCOL** newHandle, IN CHAR16* fileName, IN EFI_FILE_MODES openMode, IN EFI_FILE_ATTRIBUTES attributes, IN OUT EFI_FILE_IO_TOKEN* token);
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_GET_INFO) (IN EFI_FILE_PROTOCOL* self,IN const EFI_GUID* informationType,IN OUT UINTN* bufferSize,OUT VOID* buffer);
	typedef EFI::EFI_STATUS(EFIAPI* EFI_FILE_SET_INFO) (IN EFI_FILE_PROTOCOL* self,IN const EFI_GUID* informationType,IN UINTN bufferSize,IN VOID* buffer);
