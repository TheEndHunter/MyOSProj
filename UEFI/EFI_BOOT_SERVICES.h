...
namespace EFI
{
	...
	CONST UINT64 EFI_BOOT_SERVICES_SIGNATURE = 0x56524553544f4f42;
	CONST UINT64 EFI_BOOT_SERVICES_REVISION = EFI_SPECIFICATION_VERSION;

	CONST UINT32 EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL = 0x00000001;
	CONST UINT32 EFI_OPEN_PROTOCOL_GET_PROTOCOL = 0x00000002;
	CONST UINT32 EFI_OPEN_PROTOCOL_TEST_PROTOCOL = 0x00000004;
	CONST UINT32 EFI_OPEN_PROTOCOL_BY_CHILD_CONTROLLER = 0x00000008;
	CONST UINT32 EFI_OPEN_PROTOCOL_BY_DRIVER = 0x00000010;
	CONST UINT32 EFI_OPEN_PROTOCOL_EXCLUSIVE = 0x00000020;
	...
	typedef EFI::EFI_STATUS(EFIAPI* EFI_IMAGE_START) (IN EFI::EFI_HANDLE ImageHandle, OUT UINTN* ExitDataSize, OUT CONST CHAR16** ExitData OPTIONAL);
	typedef EFI::EFI_STATUS(EFIAPI* EFI_EXIT) (IN EFI::EFI_HANDLE ImageHandle, IN EFI::EFI_STATUS ExitStatus, IN UINTN ExitDataSize, IN CONST CHAR16* ExitData OPTIONAL);
