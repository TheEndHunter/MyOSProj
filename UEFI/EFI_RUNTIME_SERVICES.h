...
namespace EFI
{
    ...
    typedef EFI_STATUS (EFIAPI* EFI_GET_NEXT_VARIABLE_NAME)(IN OUT UINTN* VariableNameSize,IN OUT CONST CHAR16* VariableName,IN OUT EFI_GUID* VendorGuid);
	typedef EFI_STATUS (EFIAPI* EFI_SET_VARIABLE)(IN CONST CHAR16* VariableName,IN const EFI_GUID* VendorGuid,IN UINT32 Attributes,IN UINTN DataSize,IN VOID* Data);
